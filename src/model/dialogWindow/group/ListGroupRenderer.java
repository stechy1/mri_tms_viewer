...
public class ListGroupRenderer extends JPanel implements ListCellRenderer<GroupModel>, ActionListener {
	...
	@Override
	public Component getListCellRendererComponent(JList<? extends GroupModel> list, GroupModel value,
